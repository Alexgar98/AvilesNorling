...
class Helper (contexto : Context) : SQLiteOpenHelper(contexto, "propiedades", null, 18) {
    override fun onCreate(p0: SQLiteDatabase?) {
        ...
        p0.execSQL("CREATE TABLE propiedades (referencia TEXT PRIMARY KEY, fecha DATE, url TEXT, tipoInmueble INTEGER, tipoOferta INTEGER," +
                ...
                "personas INTEGER, dormitorios INTEGER, superficie INTEGER, banos INTEGER, vacacional TEXT)")
    }
